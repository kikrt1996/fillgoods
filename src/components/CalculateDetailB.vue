...
export default {
  ...
  methods: {
    ...
    setdataForLocal() {
      ...
      const calculateB = this.tempDataForLocal ? this.tempDataForLocal : [];
      calculateB.push({
      ...
      this.tempDataForLocal = calculateB;
      localStorage.setItem("calculate", JSON.stringify(calculateB));
